...
#   3. The last test should return "failure" as it will attempt to validate
...
doPlainPOST "http://localhost:8250/v1/validatecookie" "request" "c"  "WebService--ValidateCookie-FLAGS=1"
